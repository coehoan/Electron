...
async function restore() {
    ...
    fs.readdirSync(oldPath).forEach((e) => {
    ...
    try {
        // tmp 폴더를 oldPath로 이동
        await fse.move(tmpFolderPath, oldPath, {overwrite: true});
        console.log('tmpFolder move completed');

        // 앱 다시 시작
        app.relaunch();
        app.quit();
    } catch (error) {
        console.error('Error moving tmpFolder:', error);
    }
